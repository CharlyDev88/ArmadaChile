...
?>
<div class="wrap">
	<h2><?php _e( 'WP FAQ with ', 'sp-faq' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'sp-faq' ); ?></span></h2><br />	
	<style>
		...
		<div id="post-body" class="metabox-holder columns-2">
				    ...
				    <thead>
				    	<tr>
				    		...
				    		<th>
				    			...
				    			<a href="<?php echo SP_FAQ_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=FAQ&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
				    		</th>
				    	</tr>
				    </thead>
			...
			<div id="postbox-container-1" class="postbox-container wpos-sidebar">
				<div class="wpos-epb-wrap">
					...
					<ul>
						<li><b>40+ Utility Plugins</b> including <span>WP FAQ premium </span> version.</li>
					...
					<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo SP_FAQ_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=FAQ&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
				</div>
