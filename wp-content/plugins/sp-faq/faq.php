...
if( ! defined( 'SP_FAQ_VERSION' ) ) {
	define( 'SP_FAQ_VERSION', '3.6.2' ); // Version of plugin
}
...
if( ! defined( 'SP_FAQ_PLUGIN_LINK' ) ) {
	define( 'SP_FAQ_PLUGIN_LINK', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=FAQ&utm_campaign=Features-PRO' ); // Plugin url
}
